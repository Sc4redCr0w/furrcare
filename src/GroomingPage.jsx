          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="flex justify-between items-center">
                ...
                <button className="bg-orange-400/20 hover:bg-orange-400/30 text-orange-400 w-10 h-10 flex items-center justify-center rounded-full backdrop-blur-sm transition-all duration-300">
