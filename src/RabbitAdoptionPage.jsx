...
const RabbitAdoptionPage = ({ onGoHome, onGoBack, user, onLogout, onNavigateToCheckup, onNavigateToGrooming }) => {
  ...
  useEffect(() => {
    const fetchRabbits = async () => {
      try {
        ...
        // Preload all rabbit images
        const imagePromises = data.map((rabbit) => {
        ...
        console.error('Error fetching rabbits data:', e);
