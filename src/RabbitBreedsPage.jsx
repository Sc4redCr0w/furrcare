...
const RabbitBreedsPage = ({ onGoHome, onAdoptNow, user, onLogout, onNavigateToCheckup, onNavigateToGrooming }) => {
  ...
  const handlePrev = () => {
    setCurrentIndex((prev) => (prev === 0 ? rabbitBreeds.length - 1 : prev - 1));
  };

  const handleNext = () => {
    setCurrentIndex((prev) => (prev === rabbitBreeds.length - 1 ? 0 : prev + 1));
  };
            ...
            >
              ...
              <div className="space-y-6">
                <h1 className="text-6xl lg:text-7xl font-bold leading-tight">
                  ...
                  <div className="text-orange-400">RABBIT BREEDS</div>
                </h1>
                    ...
                    >
                      <div className="flex items-center gap-6">
                        ...
                        <div className="flex-1">
                          <h3 className="text-2xl font-bold mb-2">{rabbit.name}</h3>
...
export default RabbitBreedsPage;
